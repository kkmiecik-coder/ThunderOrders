    ...
    function getStepDefs(tour) {
        return [
            ...
            },
            {
                ...
                title: 'Macierz seta',
                text: 'Tu sprawdzisz które produkty z seta już masz, które zostały sclaimowane przez innych, a które jeszcze są wolne. Kompletuj set i zbieraj je wszystkie! 💪',
