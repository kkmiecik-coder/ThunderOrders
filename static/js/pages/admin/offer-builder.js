            ...
            if (groups.length) {
                ...
                groups.forEach(function(g) {
                    ...
                    html += '<div class="audience-result-item" data-type="group" data-id="' + g.id + '" data-name="' + safeName + '">'
                        ...
                        + '<div class="audience-result-text">'
                        +     '<span class="audience-result-name">' + safeName + '</span>'
                        +     '<span class="audience-result-sub">' + g.member_count + ' os.</span>'
                        + '</div>'
                        + '</div>';
                });
            }
            if (users.length) {
                ...
                users.forEach(function(u) {
                    ...
                    html += '<div class="audience-result-item" data-type="user" data-id="' + u.id + '" data-name="' + safeName + '">'
                        ...
                        + '<div class="audience-result-text">'
                        +     '<span class="audience-result-name">' + safeName + '</span>'
                        +     '<span class="audience-result-sub">' + safeEmail + '</span>'
                        + '</div>'
                        + '</div>';
                });
            }
