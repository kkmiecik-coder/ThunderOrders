...
| [static/js/pages/admin/shipping-requests.js](../../../static/js/pages/admin/shipping-requests.js) | `openShippingRequestsModal(ids)`, render listy i szczegółów, stan edycji, pasek zbiorczy, walidacja, zapis; usunięcie `openBulkCostModal`, `submitBulkCosts`, `distributeBulkCost`, `toggleShippingEdit` |
